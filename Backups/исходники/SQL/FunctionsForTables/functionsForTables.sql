...
CREATE OR REPLACE FUNCTION data_insertion_for_tickets_scalar(
	_price FLOAT,
	_flight INT,
	_passanger_id INT DEFAULT -1,
	OUT res INT
) AS 
$BODY$
	BEGIN
...
DROP FUNCTION data_insertion_for_tickets_scalar;
SELECT * FROM data_insertion_for_tickets_scalar(200, 5, 2);
...
DROP FUNCTION add_flight;

SELECT * FROM add_flight('2023-06-04 20:40:00', '2023-06-04 23:55:00', 'Amsterdam', 'Moscow', 'ES83', 'a');
SELECT * FROM add_flight('2023-06-11 07:25:00', '2023-06-11 11:00:00', 'Moscow', 'Paris', 'IO98', 'aa');
SELECT * FROM add_flight('2023-11-28 15:30:00', '2023-11-28 19:15:00', 'London', 'Walles', 'ZX78', 'aaa');
SELECT * FROM add_flight('2023-11-18 12:10:00', '2023-11-18 15:55:00', 'Kishenev', 'London', 'ML03', 'b');
SELECT * FROM add_flight('2023-12-23 10:00:00', '2023-12-24 12:30:00', 'Singapour', 'New-York', 'VY12', 'bb');
SELECT * FROM add_flight('2023-12-28 17:05:00', '2023-12-29 16:20:00', 'St. Petersberg', 'Santafe', 'TY34', 'bbb');
